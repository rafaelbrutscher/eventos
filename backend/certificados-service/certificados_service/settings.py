...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DB_USERNAME', 'eventos'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'eventos123'),
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'seu_email@gmail.com'  # Alterar em produção
EMAIL_HOST_PASSWORD = 'sua_senha_app'    # Alterar em produção
DEFAULT_FROM_EMAIL = 'Sistema de Eventos <seu_email@gmail.com>'
